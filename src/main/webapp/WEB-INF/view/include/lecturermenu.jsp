...
<c:if test="${sessionScope.lecturerId==null}">
...
<c:if test="${sessionScope.lecturerId!=null && sessionScope.role == 2}">
    <%-- Admin is logged in : Admin Menu --%>
    <a href="#">Home</a> | <a href="<s:url value="/admin/lecturer"/>">Lecturer List</a> | <a href="${url_logout}">Logout</a>
</c:if>
